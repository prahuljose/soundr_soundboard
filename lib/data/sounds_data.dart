...
class SoundsData {
  static const List<SoundModel> all = [
    SoundModel(id: 's1', name: 'Drum Hit',  file: 'drum_hit.wav',  category: 'Drums', emoji: '🥁', duration: 0.5),
    SoundModel(id: 's2', name: 'Snare',     file: 'snare.wav',     category: 'Drums', emoji: '🪘', duration: 0.5),
    // SoundModel(id: 's3', name: 'Hi-Hat',    file: 'hihat.mp3',     category: 'Drums', emoji: '🎵'),
    SoundModel(id: 's4', name: 'Kick',      file: 'kick.wav',      category: 'Drums', emoji: '💥', duration: 0.5),
