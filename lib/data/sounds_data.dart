...
class SoundsData {
  static const List<SoundModel> all = [
    SoundModel(id: 's1', name: 'Drum Hit',  file: 'drum_hit.wav',  category: 'Drums', emoji: '🥁'),
    SoundModel(id: 's2', name: 'Snare',     file: 'snare.wav',     category: 'Drums', emoji: '🪘'),
    // SoundModel(id: 's3', name: 'Hi-Hat',    file: 'hihat.mp3',     category: 'Drums', emoji: '🎵'),
    SoundModel(id: 's4', name: 'Kick',      file: 'kick.wav',      category: 'Drums', emoji: '💥'),
    ...
    // SoundModel(id: 's11',name: 'Swoosh1',    file: 'swoosh.mp3',    category: 'FX1',    emoji: '💨'),
  ];
