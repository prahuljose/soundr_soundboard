...
class SoundsData {
  static const List<SoundModel> all = [
    ...
    SoundModel(id: 's11', name: 'Frickin’',          file: 'fuckin.wav',            category: 'Memes',      emoji: '🤬'),
    ...
    SoundModel(id: 's21', name: 'Phone Notification', file: 'android_notification.wav', category: 'UI',       emoji: '📱'),
    SoundModel(id: 's22', name: 'Augh',            file: 'augh.wav',              category: 'Reactions',  emoji: '😩'),
    SoundModel(id: 's23', name: 'Bad Boy Riff', file: 'bad_to_the_bone.wav',   category: 'Music',      emoji: '💀'),
    SoundModel(id: 's24', name: 'Bombo Shout',       file: 'bomboclat.wav',         category: 'Memes',      emoji: '💣'),
    ...
    SoundModel(id: 's28', name: 'Chat App Ping',         file: 'discord.wav',           category: 'UI',         emoji: '🎮'),
    ...
    SoundModel(id: 's37', name: 'Brick Snap',            file: 'lego.wav',              category: 'Memes',      emoji: '🧱'),
    ...
    SoundModel(id: 's41', name: 'Taco Bong',  file: 'taco_bell_bell.wav',    category: 'Memes',      emoji: '🔔'),
    ...
    SoundModel(id: 's48', name: 'Why Are You…?', file: 'why_are_you_gay.wav',   category: 'Memes',      emoji: '🤔'),
    ...
    SoundModel(id: 's57', name: 'Anita Max Wynn',  file: 'anita_max_wynn_drake.wav',          category: 'Memes',      emoji: '🎤'),
    ...
    SoundModel(id: 's60', name: 'Plumber Game Over',       file: 'game_over_super_mario.wav',         category: 'Gaming',     emoji: '🎮'),

    SoundModel(id: 's61', name: 'Anime Prowler',          file: 'goku_prowler.wav',                  category: 'Anime',      emoji: '⚡'),
    ...
    SoundModel(id: 's64', name: 'Heheha King',   file: 'hehehe_ha_clash_royale.wav',        category: 'Gaming',     emoji: '👑'),
    ...
    SoundModel(id: 's67', name: 'Tiny Green Master',       file: 'lego_yoda_death.wav',               category: 'Memes',      emoji: '🟩'),
    SoundModel(id: 's68', name: 'Lie Detector Wrong',    file: 'lie_detector_wrong.wav',            category: 'Effects',    emoji: '🚨'),
    SoundModel(id: 's69', name: 'Blocky Cave',        file: 'minecraft_cave_noise.wav',          category: 'Gaming',     emoji: '⛏️'),
    ...
    SoundModel(id: 's73', name: 'Late-Night Intro',         file: 'pornhub_intro.wav',                 category: 'Memes',      emoji: '🟧'),
    ...
    SoundModel(id: 's76', name: 'Spit On That…',    file: 'spit_on_that_thang.wav',            category: 'Memes',      emoji: '🗣️'),
    SoundModel(id: 's77', name: 'Sponge Guy',             file: 'spongebob.wav',                      category: 'Cartoons',   emoji: '🧽'),
    SoundModel(id: 's78', name: 'W In The Chat',   file: 'w_in_the_chat_drake.wav',           category: 'Memes',      emoji: '🏆'),
    ...
    SoundModel(id: 's81', name: 'USB Connect',     file: 'windows_10_usb_sound.wav',          category: 'UI',         emoji: '💻'),
    ...
    SoundModel(id: 's127', name: 'Disappointed Sponge', file: 'disappointed_spongebob.mp3',           category: 'Cartoons',  emoji: '🧽'),
    ...
    SoundModel(id: 's145', name: 'Retro PC Error',      file: 'windows_xp_error.mp3',                  category: 'UI',        emoji: '🖥️'),
    SoundModel(id: 's146', name: 'Retro PC Shutdown',   file: 'windows_xp_shutdown.mp3',               category: 'UI',        emoji: '💻'),
